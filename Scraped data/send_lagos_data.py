...
def load_lagos_data():
    try:
        with open("lagos_food.json", "r", encoding="utf-8") as file:
            return json.load(file)
    except FileNotFoundError:
        print("❌ Error: lagos_food.json file not found!")
        return []
    except json.JSONDecodeError:
        print("❌ Error: Invalid JSON format in lagos_food.json!")
        return []
...
if __name__ == "__main__":
    lagos_data = load_lagos_data()
    send_to_backend(lagos_data)
    print("✅ Lagos data transfer completed!")
