...
def load_oyo_data():
    try:
        with open("oyo_food.json", "r", encoding="utf-8") as file:
            return json.load(file)
    except FileNotFoundError:
        print("❌ Error: oyo_food.json file not found!")
        return []
    except json.JSONDecodeError:
        print("❌ Error: Invalid JSON format in oyo_food.json!")
        return []
...
if __name__ == "__main__":
    oyo_data = load_oyo_data()
    send_to_backend(oyo_data)
    print("✅ oyo data transfer completed!")
